<%-- 
    Document   : forgot
    Created on : Dec 5, 2016, 8:58:05 PM
    Author     : Nick
--%>
        ...
        <header><b>-CHAT</b></header>
         <div class = "form" id = "forgot-password">
            ...
            <s:form action="forgot">
                <div class="field-wrap"><s:textfield name="userId" label="Login ID" autocomplete="off"/></div>
                <div class="field-wrap"><s:textfield name="email" label="Email" autocomplete="off"/></div>
